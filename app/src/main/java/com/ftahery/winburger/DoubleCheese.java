...
public class DoubleCheese extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    doubleCheese.setBackgroundResource(R.drawable.button_rounded_brown_filled);
            ...
            new CountDownTimer(5000, 500) {
              ...
              public void onTick(long millisUntilFinished) {
                ...
                if (animationCounter[0] == 4) {
                  ...
                  insertImage3.setImageResource(R.drawable.patty);
                } else if (animationCounter[0] == 6) {
                  insertImage4.setImageResource(R.drawable.cheese);
                } else if (animationCounter[0] == 7) {
                  insertImage5.setImageResource(R.drawable.cucumber);
                } else if (animationCounter[0] == 8) {
                  insertImage6.setImageResource(R.drawable.salad);
                } else if (animationCounter[0] == 9) {
                  insertImage7.setImageResource(R.drawable.bun);
                }
              }
              ...
              public void onFinish() {
                ...
                displayBurger4.setImageResource(R.drawable.cheese);
                displayBurger5.setImageResource(R.drawable.cucumber);
                displayBurger6.setImageResource(R.drawable.salad);
                displayBurger7.setImageResource(R.drawable.bun);
              }
            }.start();
          }
        });
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      ...
      case R.id.done_button:
        if (count == 6) {
          ...
          if (bitmap1 == bottom
            ...
            final MediaPlayer mp = MediaPlayer.create(DoubleCheese.this, R.raw.success);
            mp.start();
          } else {
            popup(R.layout.failure_pop_up);
            final MediaPlayer mp = MediaPlayer.create(DoubleCheese.this, R.raw.wrong_buzzer);
            mp.start();
          }
      ...
      case R.id.classic_burger:
        startActivity(new Intent(DoubleCheese.this, Classic.class));
        break;
      case R.id.supreme:
        startActivity(new Intent(DoubleCheese.this, Supreme.class));
        break;
      case R.id.max_burger:
        startActivity(new Intent(DoubleCheese.this, Max.class));
        break;
    }
  }

  private void popup(int failure_pop_up) {
    final Dialog dialog = new Dialog(DoubleCheese.this);
