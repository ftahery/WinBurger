...
public class Classic extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    classic.setBackgroundResource(R.drawable.button_rounded_brown_filled);
            ...
            new CountDownTimer(4000, 500) {
              ...
              public void onTick(long millisUntilFinished) {
                ...
                if (animationCounter[0] == 4) {
                  ...
                  insertImage4.setImageResource(R.drawable.ketchup);
                } else if (animationCounter[0] == 7) {
                  insertImage5.setImageResource(R.drawable.salad);
                } else if (animationCounter[0] == 8) {
                  insertImage6.setImageResource(R.drawable.bun);
                }
              }
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      ...
      case R.id.done_button:
        if (count == 5) {
          ...
          if (bitmap1 == bottom
            ...
            final MediaPlayer mp = MediaPlayer.create(Classic.this, R.raw.success);
            mp.start();
          } else {
            popup(R.layout.failure_pop_up);
            final MediaPlayer mp = MediaPlayer.create(Classic.this, R.raw.wrong_buzzer);
            mp.start();
          }
      ...
      case R.id.double_cheese:
        startActivity(new Intent(Classic.this, DoubleCheese.class));
        break;
      case R.id.supreme:
        startActivity(new Intent(Classic.this, Supreme.class));
        break;
      case R.id.max_burger:
        startActivity(new Intent(Classic.this, Max.class));
        break;
    }
  }

  private void popup(int failure_pop_up) {
    final Dialog dialog = new Dialog(Classic.this);
