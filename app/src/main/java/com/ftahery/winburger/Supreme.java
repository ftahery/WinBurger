...
public class Supreme extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    supreme.setBackgroundResource(R.drawable.button_rounded_brown_filled);
            ...
            new CountDownTimer(5000, 500) {
              ...
              public void onTick(long millisUntilFinished) {
                ...
                if (animationCounter[0] == 4) {
                  ...
                  insertImage3.setImageResource(R.drawable.tomato);
                } else if (animationCounter[0] == 6) {
                  insertImage4.setImageResource(R.drawable.patty);
                } else if (animationCounter[0] == 7) {
                  insertImage5.setImageResource(R.drawable.onion);
                } else if (animationCounter[0] == 8) {
                  insertImage6.setImageResource(R.drawable.omelette);
                } else if (animationCounter[0] == 9) {
                  insertImage7.setImageResource(R.drawable.salad);
                } else if (animationCounter[0] == 10) {
                  insertImage8.setImageResource(R.drawable.bun);
                }
              }
              ...
              public void onFinish() {
                ...
                displayBurger3.setImageResource(R.drawable.tomato);
                displayBurger4.setImageResource(R.drawable.patty);
                displayBurger5.setImageResource(R.drawable.onion);
                displayBurger6.setImageResource(R.drawable.omelette);
                displayBurger7.setImageResource(R.drawable.salad);
                displayBurger8.setImageResource(R.drawable.bun);
              }
            }.start();
          }
        });
    ...
    switch (v.getId()) {
      ...
      case R.id.done_button:
        if (count == 7) {
          ...
          Bitmap onion =
              ((BitmapDrawable) getResources().getDrawable(R.drawable.onion)).getBitmap();
          ...
          if (bitmap1 == bottom
            ...
            final MediaPlayer mp = MediaPlayer.create(Supreme.this, R.raw.success);
            mp.start();
          } else {
            popup(R.layout.failure_pop_up);
            final MediaPlayer mp = MediaPlayer.create(Supreme.this, R.raw.wrong_buzzer);
            mp.start();
          }
      ...
      case R.id.double_cheese:
        startActivity(new Intent(Supreme.this, DoubleCheese.class));
        break;
      case R.id.classic_burger:
        startActivity(new Intent(Supreme.this, Classic.class));
        break;
      case R.id.max_burger:
        startActivity(new Intent(Supreme.this, Max.class));
        break;
    }
  }

  private void popup(int failure_pop_up) {
    final Dialog dialog = new Dialog(Supreme.this);
